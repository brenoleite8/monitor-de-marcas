...
CREATE TABLE tb_materiais_estudo( 
      ...
      palavras_chave blob sub_type 1    NOT NULL , 
      link_video blob sub_type 1   , 
      link_site blob sub_type 1   , 
...
CREATE TABLE tb_processo( 
      ...
      comprovante_file_name blob sub_type 1   , 
      comprovante_content blob sub_type 1   , 
      system_unit_id integer    NOT NULL , 
      system_user_id_create integer    NOT NULL , 
      system_user_id_update integer   , 
      created_at timestamp    NOT NULL , 
...
CREATE TABLE tb_processo_evento( 
      ...
      texto_evento blob sub_type 1    NOT NULL , 
